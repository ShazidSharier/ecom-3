...
Route::get('/about-us',[ShopGridsController::class,'aboutus'])->name('about-us');
...
Route::middleware(['auth:sanctum', config('jetstream.auth_session'), 'verified',])->group(function () {
    ...
    Route::get('/check-product-name',[OrderController::class,'checkProductName'])->name('check-product-name');
    Route::get('/check-user-email',[OrderController::class,'checkUserEmail'])->name('check-user-email');
