                    ...
                    <div class="card-body">
                        ...
                        <form class="form-horizontal" action="{{ route('shipping.update',$shipping->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" value="{{$shipping->name}}" name="name" placeholder="Enter your Shipping Name" type="text">
                                </div>
                            </div>
                            <div class="row mb-4">
                                <label  class="col-md-3 form-label">Shipping Charge</label>
                                <div class="col-md-9">
                                    <input class="form-control" value="{{$shipping->code}}" name="code" placeholder="Enter your Shipping Charge" type="text">
                                </div>
                            </div>
