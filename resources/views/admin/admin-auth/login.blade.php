...
<head>
    ...
    <!-- TITLE -->
    <title>Parampara Ecommerce Website Dashboard Login</title>

    <!-- FAVICON -->
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('/') }}admin/assets/images/logo/logo.png" />
...
{{--                            <a href="https://themeforest.net/user/spruko/portfolio" class="btn ripple btn-pink" target="_blank">Our Portfolio</a>--}}
{{--                        </div>--}}
{{--                    </div>--}}
    ...
    <div>
        ...
        <div class="col col-login mx-auto text-center">
            <a href="" class="text-center">
                <img src="{{ asset('/') }}admin/assets/images/logo/logo.png" class="header-brand-img" alt="">
            </a>
        </div>
