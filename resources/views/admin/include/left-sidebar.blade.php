    ...
    <div class="app-sidebar">
        <div class="side-header">
            <a class="header-brand1" href="{{ route('dashboard') }}">
                <img src="{{ asset('/') }}admin/assets/images/logo/logo.png" style="height: 50px;width: 120px" class="header-brand-img light-logo1" alt="logo">
            </a><!-- LOGO -->
        </div>
            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a href="{{route('shipping.index')}}" class="slide-item">Shipping</a></li>
                    </ul>
                </li>
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        <li><a href="{{ route('order') }}" class="slide-item">All Order</a></li>
                    </ul>
                </li>
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                    ...
                    <ul class="slide-menu">
                        <li><a href="{{ route('all-customer') }}" class="slide-item">All Customer</a></li>
                    </ul>
                </li>
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                    ...
                    <ul class="slide-menu">
                        <li><a href="{{ route('user.index') }}" class="slide-item">All User</a></li>
