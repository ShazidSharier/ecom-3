                    ...
                    <div class="card-body">
                        ...
                        <form class="form-horizontal" action="{{ route('product.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" name="brand_id" placeholder="Enter Product brand " type="text">
...
{{--                                    </select>--}}
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" onblur="checkProductName(this.value)" name="name" placeholder="Enter Product Name" type="text">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-9 form-group">
                                    <select multiple class="form-control select2 form-select" name="color[]" data-placeholder="Choose one">
