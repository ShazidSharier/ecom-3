                    ...
                    <div class="card-body">
                        ...
                        <form class="form-horizontal" action="{{ route('product.update', $product->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" value="{{$product->brand_id}}" name="brand_id" placeholder="Enter Product brand" type="text">
...
{{--                                    </select>--}}
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" onblur="checkProductName(this.value)" value="{{$product->name}}" name="name" placeholder="Enter Product Name" type="text">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-9 form-group">
                                    <select multiple name="color[]" class="form-control select2 form-select w-100" data-placeholder="Choose one">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-9 form-group">
                                    <select multiple name="size[]" class="form-control select2 form-select w-100" data-placeholder="Choose one">
                                        <option label="Choose one"></option>
                            ...
                            <div class="row mb-4">
                                <label  class="col-md-3 form-label">Product Shipping Charge</label>
                                <div class="col-md-9 form-group">
                                    <select multiple name="shipping[]" class="form-control select2 form-select w-100" data-placeholder="Choose one">
                                        <option label="Choose one"></option>
                                        @foreach($shippings as $shipping)
                                            <option value="{{$shipping->id}}" @foreach($product->productShippings as $productShipping) {{$shipping->id == $productShipping->shipping_id ? 'selected' : ''}}  @endforeach>{{$shipping->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
