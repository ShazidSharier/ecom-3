        ...
        <div class="container">
            ...
            <div class="cart-list-head mt-3">
                ...
                @foreach($products as $product)
                    ...
                    @php($shipping = $product->options->shipping )
                @endforeach
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="total-amount">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="right">
                                    <ul>
                                        <li>Cart Subtotal<span>{{ round($sum) }}</span></li>
                                        <li>Tax Amount (0%)<span>{{ $tax = round( ($sum * 0) ) }}</span></li>
                                        <li>Shipping Cost <span> {{ $shipping }} </span></li>
                                        <li class="last">Total Payable<span>{{  $grandTotal = $sum + $tax + $shipping }}</span></li>
                                    </ul>
                                    <div class="button">
