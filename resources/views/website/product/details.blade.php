                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 col-md-12 col-12">
                            <div class="product-info">
                                ...
                                <p class="category">Product Category <i class="lni lni-tag"></i>{{ $product->category->name }}</p>
                                <p class="category">Product Sub Category <i class="lni lni-tag"></i>{{ $product->subCategory->name }}</p>
                                <p class="category">Product Brand <i class="lni lni-tag"></i>{{ $product->brand_id }}</p>
                                <p class="category">Product Selling Unit <i class="lni lni-tag"></i>{{ $product->unit->name }}</p>
                                <h3 class="price">TK.  {{ $product->selling_price }} <del class="text-danger">TK. {{ $product->regular_price }}</del></h3>
                                ...
                                <p class="" style="color: black">
                                    <b>Shipping  :</b>
                                    @foreach($product->productShippings as $key2 => $productShipping)
                                        <label class="me-2"><input type="radio" {{$key2 == 0 ? 'checked' : ''}} name="shipping" value="{{$productShipping->shipping->code}}"/> {{$productShipping->shipping->name}} </label>
                                    @endforeach
                                </p>
                                <hr/>
